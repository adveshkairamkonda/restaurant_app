...
orders = {
    ...
    3: {"category": "Continental", "status": "Preparing"}
    4: {"category": "Tea / Coffee", "status": "Preparing"}
}


@app.route('/')
def home():
    log.info("Welcome to Pride of Hyderabad!")
    return "Welcome to Pride of Hyderabad!"
